    ...
    return (
        <section className="w-full space-y-4 sm:space-y-6">
            ...
            <div className="max-w-[85%] m-auto space-y-2 mt-4">
                <h2 className={`text-foreground-blue text-center text-[24px] md:text-[32px] ${poppinsBold.className}`}>Browse the Range</h2>
                <h3 className={`text-zinc-500 text-center text-[16px] lg:text-[20px] ${poppinsRegular.className}`}>Miniatures for Every Imagination—Unique, Detailed, and Crafted Just for You!</h3>
            </div>
